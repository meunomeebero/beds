...
- Inter4.1: bundled font files and [SIL Open Font License](packages/espaco-ui/fonts/OFL.txt).
- Geist Mono: bundled font and [SIL Open Font License](packages/espaco-ui/fonts/Geist-OFL.txt).
