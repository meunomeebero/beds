...
- This repository owns the portable design system. `@espaco/ui` remains the package/import name for compatibility; BEDS is the repository name.
...
- Canonical docs: `docs/design/espaco-library/`; source: `packages/espaco-ui/src/`; generated package docs/dist: build outputs, never hand-edit.
