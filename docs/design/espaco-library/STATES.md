...
| Badge status |Caller label/tone → noninteractive text with decorative dot |No automatic live region or focus stop; all five tones preserve complete text; long labels wrap; default tag badge unchanged |
