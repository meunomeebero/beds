...
export const typography = Object.freeze({
  ...
  caption: { size: 11, line: 16, weight: 400, tracking: 0, evidence: 'M' },
  overline: { size: 11, line: 16, weight: 500, tracking: .55, evidence: 'M' },
  command: { size: 15, line: 24, weight: 400, tracking: -.1, evidence: 'M' },
});
export const geometry = Object.freeze({
  sidebar: 264, rail: 62, breakpoint: 768, mobileGutter: 16, desktopGutter: 24,
  ...
  chat: 640, home: 720, dashboard: 880, composerRadius: 20, composerInput: 120, agentStrip: 36,
